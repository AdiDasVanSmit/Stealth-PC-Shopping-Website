...
$sql = "INSERT INTO shop_register (F_name,U_name,Email,Phone,City,Pin,Password,Gender) VALUES ('$fname', '$uname', '$email', '$number', '$city', '$pin', '$pass', '$gender')";
...
if ($conn->query($sql)) 
{
    ...
    <div class='modal' id='modal'>
        <div class='modal-content'>
            ...
            <p>Username has been Registered Succesfully.</p>
        </div>
    </div>";
} 
else 
{
    echo "
        <div class='modal' id='modal'>
            <div class='modal-content'>
                <span class='close' onclick='closeModal()'>&times;</span>
                <p>An technical Error has been occured. Please Try Again</p>
            </div>
        </div>";
}
